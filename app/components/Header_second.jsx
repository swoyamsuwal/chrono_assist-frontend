...
export default function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 bg-gray-900 border-b border-gray-800 shadow-xl">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center space-x-4">
            ...
            <Link href="/" className="text-xl font-extrabold text-white tracking-wider hidden sm:block">
              Chrono Assist
            </Link>
          </div>
      ...
      {/* Mobile Menu Panel */}
      <div className={`md:hidden ${isMenuOpen ? "block" : "hidden"} absolute w-full bg-gray-900 border-t border-gray-800`}>
